...
Another example would be to configure a connection to a link:http://help.infragistics.com/reportplus/how-to-configure-data-sources#MicrosoftSQLServer[SQL Server] database. In this case you would have to navigate to the New Data Source section, then click Microsoft SQL Server.
