...
For some data sources, there's another type of binding available called URL binding, which allows you to link dashboard filters to data sets or assets that can be retrieved with a URL, such as in link:http://help.infragistics.com/reportplus/how-to-configure-data-sources#SharePointServer[SharePoint], link:http://help.infragistics.com/reportplus/how-to-configure-data-sources#ODataService[OData] and link:http://help.infragistics.com/reportplus/how-to-configure-data-sources#WebResource[Web Resources].
