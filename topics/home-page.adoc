...
image:images/doc-icon.png[DPC-iCON] link:http://download.infragistics.com/marketing/ReportPlus/Developer-Docs/ReportPlus%20Architecture%20Guide.pdf[ReportPlus Architecture Guide]