...
* _Widget filters_ (a.k.a. link:http://help.staging.infragistics.local/reportplus/data-filters#QuickFilters[QuickFilters]) are displayed in a collapsible side panel under _Widget Filters_ once a widget is maximized.

* _Dashboard filters_, on the other hand, are displayed in a collapsible panel on the right-hand side.

For more information on Dashboard Filters, check out link:http://help.infragistics.com/reportplus/dashboard-filters-and-binding[this section].
