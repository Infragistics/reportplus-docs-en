...
* *Hello World*. It generates a table with the data set retrieved from ReportPlus. At the link:http://help.infragistics.com/reportplus/diy-visualization#_creating_a_custom_visualization_step_by_step[end] of this section, there's a step by step tutorial that shows how to reproduce this sample.
